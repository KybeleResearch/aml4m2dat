...
/**
 * This is the item provider adapter for a {@link SQL2003_V3.StructuredType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StructuredTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SQL2003_V3Package.Literals.STRUCTURED_TYPE__IS_FINAL,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SQL2003_V3Package.Literals.STRUCTURED_TYPE__IS_INSTANTIABLE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SQL2003_V3Package.Literals.STRUCTURED_TYPE__SUPER_TYPE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SQL2003_V3Package.Literals.STRUCTURED_TYPE__TYPED,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SQL2003_V3Package.Literals.STRUCTURED_TYPE__ATTRIBUTES);
			childrenFeatures.add(SQL2003_V3Package.Literals.STRUCTURED_TYPE__METHODS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SQL2003_V3Package.Literals.STRUCTURED_TYPE__ATTRIBUTES,
				 SQL2003_V3Factory.eINSTANCE.createAttribute()));

		newChildDescriptors.add
			(createChildParameter
				(SQL2003_V3Package.Literals.STRUCTURED_TYPE__METHODS,
				 SQL2003_V3Factory.eINSTANCE.createMethod()));
	}
