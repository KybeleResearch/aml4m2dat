...
/**
 * This is the item provider adapter for a {@link SQL2003_V3.NumericType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NumericTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_NumericType_descriptor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_NumericType_descriptor_feature", "_UI_NumericType_type"),
				 SQL2003_V3Package.Literals.NUMERIC_TYPE__DESCRIPTOR,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		NumericTypes labelValue = ((NumericType)object).getDescriptor();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(NumericType.class)) {
			case SQL2003_V3Package.NUMERIC_TYPE__DESCRIPTOR:
