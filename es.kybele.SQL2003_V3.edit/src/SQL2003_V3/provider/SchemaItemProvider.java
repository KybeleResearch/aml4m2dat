...
import SQL2003_V3.impl.PredefinedTypeImpl;


/**
 * This is the item provider adapter for a {@link SQL2003_V3.Schema} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SchemaItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SQL2003_V3Package.Literals.SCHEMA__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SQL2003_V3Package.Literals.SCHEMA__BEHAVIOURAL_COMPONENTS);
			childrenFeatures.add(SQL2003_V3Package.Literals.SCHEMA__DATATYPES);
			childrenFeatures.add(SQL2003_V3Package.Literals.SCHEMA__TABLES);
			childrenFeatures.add(SQL2003_V3Package.Literals.SCHEMA__DOMAINS);
		}
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(
				SQL2003_V3Package.Literals.SCHEMA__BEHAVIOURAL_COMPONENTS,
				SQL2003_V3Factory.eINSTANCE.createFunction()));
	
		newChildDescriptors.add(createChildParameter(
				SQL2003_V3Package.Literals.SCHEMA__BEHAVIOURAL_COMPONENTS,
				SQL2003_V3Factory.eINSTANCE.createProcedure()));
	
		newChildDescriptors.add(createChildParameter(
				SQL2003_V3Package.Literals.SCHEMA__DATATYPES,
				SQL2003_V3Factory.eINSTANCE.createARRAY()));
		...
		newChildDescriptors.add(createChildParameter(
				SQL2003_V3Package.Literals.SCHEMA__DATATYPES,
				SQL2003_V3Factory.eINSTANCE.createDistinctType()));
		//
		// newChildDescriptors.add
		// (createChildParameter
		// (SQL2003_evoPackage.Literals.SCHEMA__DATATYPES,
		...
		newChildDescriptors.add(createChildParameter(
				SQL2003_V3Package.Literals.SCHEMA__DATATYPES,
				SQL2003_V3Factory.eINSTANCE.createMULTISET()));
		...
		newChildDescriptors.add(createChildParameter(
				SQL2003_V3Package.Literals.SCHEMA__DATATYPES,
				SQL2003_V3Factory.eINSTANCE.createROW()));
	
		newChildDescriptors.add(createChildParameter(
				SQL2003_V3Package.Literals.SCHEMA__DATATYPES,
				SQL2003_V3Factory.eINSTANCE.createReferenceType()));
	
		newChildDescriptors.add(createChildParameter(
				SQL2003_V3Package.Literals.SCHEMA__DATATYPES,
				SQL2003_V3Factory.eINSTANCE.createStructuredType()));
		...
		newChildDescriptors.add(createChildParameter(
				SQL2003_V3Package.Literals.SCHEMA__TABLES,
				SQL2003_V3Factory.eINSTANCE.createDerivedTable()));
	
		newChildDescriptors.add(createChildParameter(
				SQL2003_V3Package.Literals.SCHEMA__TABLES,
				SQL2003_V3Factory.eINSTANCE.createTypedTable()));	
	
		newChildDescriptors.add(createChildParameter(
				SQL2003_V3Package.Literals.SCHEMA__TABLES,
				SQL2003_V3Factory.eINSTANCE.createBaseTable()));	
		
		newChildDescriptors.add(createChildParameter(
				SQL2003_V3Package.Literals.SCHEMA__TABLES,
				SQL2003_V3Factory.eINSTANCE.createView()));
		
		newChildDescriptors.add
		(createChildParameter
			(SQL2003_V3Package.Literals.SCHEMA__DOMAINS,
			 SQL2003_V3Factory.eINSTANCE.createDomain()));
	}
