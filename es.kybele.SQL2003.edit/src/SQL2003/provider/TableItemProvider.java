...
/**
 * This is the item provider adapter for a {@link SQL2003.Table} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TableItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SQL2003Package.Literals.TABLE__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SQL2003Package.Literals.TABLE__VIEWS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SQL2003Package.Literals.TABLE__COLUMNS);
			childrenFeatures.add(SQL2003Package.Literals.TABLE__TRIGGERS);
			childrenFeatures.add(SQL2003Package.Literals.TABLE__RESTRICTIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SQL2003Package.Literals.TABLE__COLUMNS,
				 SQL2003Factory.eINSTANCE.createColumn()));

		newChildDescriptors.add
			(createChildParameter
				(SQL2003Package.Literals.TABLE__TRIGGERS,
				 SQL2003Factory.eINSTANCE.createTrigger()));

		newChildDescriptors.add
			(createChildParameter
				(SQL2003Package.Literals.TABLE__RESTRICTIONS,
				 SQL2003Factory.eINSTANCE.createNotNull()));

		newChildDescriptors.add
			(createChildParameter
				(SQL2003Package.Literals.TABLE__RESTRICTIONS,
				 SQL2003Factory.eINSTANCE.createUniqueConstraint()));

		newChildDescriptors.add
			(createChildParameter
				(SQL2003Package.Literals.TABLE__RESTRICTIONS,
				 SQL2003Factory.eINSTANCE.createPrimaryKey()));

		newChildDescriptors.add
			(createChildParameter
				(SQL2003Package.Literals.TABLE__RESTRICTIONS,
				 SQL2003Factory.eINSTANCE.createReferentialConstraint()));

		newChildDescriptors.add
			(createChildParameter
				(SQL2003Package.Literals.TABLE__RESTRICTIONS,
				 SQL2003Factory.eINSTANCE.createTableCheckConstraint()));
	}
