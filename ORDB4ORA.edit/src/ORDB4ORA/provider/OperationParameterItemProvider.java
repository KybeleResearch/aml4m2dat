...
/**
 * This is the item provider adapter for a {@link ORDB4ORA.OperationParameter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OperationParameterItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OperationParameter_Mode_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OperationParameter_Mode_feature", "_UI_OperationParameter_type"),
				 ORDB4ORAPackage.Literals.OPERATION_PARAMETER__MODE,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(OperationParameter.class)) {
			case ORDB4ORAPackage.OPERATION_PARAMETER__MODE:
