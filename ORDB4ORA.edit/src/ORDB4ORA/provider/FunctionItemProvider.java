...
/**
 * This is the item provider adapter for a {@link ORDB4ORA.Function} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FunctionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Function_Return_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Function_Return_feature", "_UI_Function_type"),
				 ORDB4ORAPackage.Literals.FUNCTION__RETURN,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			...
			getString("_UI_Function_type") + " " + label + "<<FUNCTION>>";
	}
