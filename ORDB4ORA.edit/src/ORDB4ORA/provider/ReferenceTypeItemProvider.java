...
/**
 * This is the item provider adapter for a {@link ORDB4ORA.ReferenceType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ReferenceTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ReferenceType_Name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ReferenceType_Name_feature", "_UI_ReferenceType_type"),
				 ORDB4ORAPackage.Literals.REFERENCE_TYPE__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ORDB4ORAPackage.Literals.REFERENCE_TYPE__TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			...
			getString("_UI_ReferenceType_type") + " " + label + "<<REF>>";
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ReferenceType.class)) {
			case ORDB4ORAPackage.REFERENCE_TYPE__NAME:
