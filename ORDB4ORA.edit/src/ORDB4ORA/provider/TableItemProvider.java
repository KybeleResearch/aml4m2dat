...
/**
 * This is the item provider adapter for a {@link ORDB4ORA.Table} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TableItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ORDB4ORAPackage.Literals.TABLE__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ORDB4ORAPackage.Literals.TABLE__RESTRICTION);
			childrenFeatures.add(ORDB4ORAPackage.Literals.TABLE__COLUMNS);
			childrenFeatures.add(ORDB4ORAPackage.Literals.TABLE__TRIGGERS);
		}
