...
/**
 * This is the item provider adapter for a {@link ORDB4ORA.View} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ViewItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ORDB4ORAPackage.Literals.VIEW__TABLES,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addComponentsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_View_components_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_View_components_feature", "_UI_View_type"),
				 ORDB4ORAPackage.Literals.VIEW__COMPONENTS,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			...
			getString("_UI_View_type") + " " + label + "<<VIEW>>";
	}
