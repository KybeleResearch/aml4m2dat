...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Long And Raw Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link ORDB4ORA.impl.LongAndRawTypeImpl#getDescriptor <em>Descriptor</em>}</li>
 *   <li>{@link ORDB4ORA.impl.LongAndRawTypeImpl#getSize_Min <em>Size Min</em>}</li>
 *   <li>{@link ORDB4ORA.impl.LongAndRawTypeImpl#getSize_Max <em>Size Max</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class LongAndRawTypeImpl extends BuiltInTypeImpl implements LongAndRawType {
	/**
	 ...
	 * @ordered
	 */
	protected static final BuiltInLongAndRawTypes DESCRIPTOR_EDEFAULT = BuiltInLongAndRawTypes.LONG;
	 ...
	 * @ordered
	 */
	protected BuiltInLongAndRawTypes descriptor = DESCRIPTOR_EDEFAULT;
	...
	protected EClass eStaticClass() {
		return ORDB4ORAPackage.Literals.LONG_AND_RAW_TYPE;
	}
	 ...
	 * @generated
	 */
	public BuiltInLongAndRawTypes getDescriptor() {
		return descriptor;
	}
	 ...
	 * @generated
	 */
	public void setDescriptor(BuiltInLongAndRawTypes newDescriptor) {
		BuiltInLongAndRawTypes oldDescriptor = descriptor;
		descriptor = newDescriptor == null ? DESCRIPTOR_EDEFAULT : newDescriptor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ORDB4ORAPackage.LONG_AND_RAW_TYPE__DESCRIPTOR, oldDescriptor, descriptor));
	}
	...
	public void setSize_Min(int newSize_Min) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ORDB4ORAPackage.LONG_AND_RAW_TYPE__SIZE_MIN, oldSize_Min, size_Min));
	}
	...
	public void setSize_Max(int newSize_Max) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ORDB4ORAPackage.LONG_AND_RAW_TYPE__SIZE_MAX, oldSize_Max, size_Max));
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ORDB4ORAPackage.LONG_AND_RAW_TYPE__DESCRIPTOR:
				setDescriptor((BuiltInLongAndRawTypes)newValue);
				return;
			case ORDB4ORAPackage.LONG_AND_RAW_TYPE__SIZE_MIN:
