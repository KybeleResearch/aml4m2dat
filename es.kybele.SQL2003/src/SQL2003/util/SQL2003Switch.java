...
public class SQL2003Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case SQL2003Package.BASE_TABLE: {
			...
			case SQL2003Package.BEHAVIOURAL_COMPONENT: {
			...
			case SQL2003Package.BINARY_STRING_TYPE: {
			...
			case SQL2003Package.BOOLEAN_TYPE: {
			...
			case SQL2003Package.CHARACTER_STRING_TYPE: {
			...
			case SQL2003Package.COLLECTION_TYPE: {
			...
			case SQL2003Package.COLUMN_CONSTRAINT: {
			...
			case SQL2003Package.CONSTRUCTED_TYPE: {
			...
			case SQL2003Package.DATA_TYPE: {
				DataType dataType = (DataType)theEObject;
				T result = caseDataType(dataType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SQL2003Package.DATETIME_FEATURE: {
			...
			case SQL2003Package.DATETIME_TYPE: {
			...
			case SQL2003Package.DERIVED_TABLE: {
			...
			case SQL2003Package.DISTINCT_TYPE: {
			...
			case SQL2003Package.FEATURE: {
				Feature feature = (Feature)theEObject;
				T result = caseFeature(feature);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SQL2003Package.FIELD: {
			...
			case SQL2003Package.INTERVAL_FEATURE: {
			...
			case SQL2003Package.INTERVAL_TYPE: {
			...
			case SQL2003Package.METHOD: {
				Method method = (Method)theEObject;
				T result = caseMethod(method);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SQL2003Package.METHOD_PARAMETER: {
			...
			case SQL2003Package.NUMERIC_FEATURE: {
			...
			case SQL2003Package.NUMERIC_TYPE: {
			...
			case SQL2003Package.PARAMETER: {
				Parameter parameter = (Parameter)theEObject;
				T result = caseParameter(parameter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SQL2003Package.PARAMETER_WITH_MODE: {
			...
			case SQL2003Package.PREDEFINED_TYPE: {
			...
			case SQL2003Package.PRIMARY_KEY: {
			...
			case SQL2003Package.REFERENCE_TYPE: {
			...
			case SQL2003Package.REFERENTIAL_CONSTRAINT: {
			...
			case SQL2003Package.STRUCTURAL_COMPONENT: {
			...
			case SQL2003Package.STRUCTURED_TYPE: {
			...
			case SQL2003Package.TABLE: {
				Table table = (Table)theEObject;
				T result = caseTable(table);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SQL2003Package.TABLE_CHECK_CONSTRAINT: {
			...
			case SQL2003Package.TABLE_CONSTRAINT: {
			...
			case SQL2003Package.TRIGGER: {
				Trigger trigger = (Trigger)theEObject;
				T result = caseTrigger(trigger);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SQL2003Package.TYPED_TABLE: {
			...
			case SQL2003Package.UNIQUE_CONSTRAINT: {
			...
			case SQL2003Package.USER_DEFINED_TYPE: {
