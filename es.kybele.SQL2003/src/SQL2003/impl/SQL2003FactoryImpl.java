 ...
 * @generated
 */
public class SQL2003FactoryImpl extends EFactoryImpl implements SQL2003Factory {
	/**
	 ...
	 * @generated
	 */
	public static SQL2003Factory init() {
		try {
			SQL2003Factory theSQL2003Factory = (SQL2003Factory)EPackage.Registry.INSTANCE.getEFactory("http://SQL2003.ecore"); 
			if (theSQL2003Factory != null) {
				return theSQL2003Factory;
			}
		}
		catch (Exception exception) {
			EcorePlugin.INSTANCE.log(exception);
		}
		return new SQL2003FactoryImpl();
	}
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case SQL2003Package.ARRAY: return createARRAY();
			case SQL2003Package.ATTRIBUTE: return createAttribute();
			case SQL2003Package.BASE_TABLE: return createBaseTable();
			case SQL2003Package.BINARY_STRING_TYPE: return createBinaryStringType();
			case SQL2003Package.BOOLEAN_TYPE: return createBooleanType();
			case SQL2003Package.CHARACTER_STRING_TYPE: return createCharacterStringType();
			case SQL2003Package.COLUMN: return createColumn();
			case SQL2003Package.DATETIME_FEATURE: return (EObject)createDatetimeFeature();
			case SQL2003Package.DATETIME_TYPE: return createDatetimeType();
			case SQL2003Package.DERIVED_TABLE: return createDerivedTable();
			case SQL2003Package.DISTINCT_TYPE: return createDistinctType();
			case SQL2003Package.FIELD: return createField();
			case SQL2003Package.FUNCTION: return createFunction();
			case SQL2003Package.INTERVAL_FEATURE: return (EObject)createIntervalFeature();
			case SQL2003Package.INTERVAL_TYPE: return createIntervalType();
			case SQL2003Package.MULTISET: return createMULTISET();
			case SQL2003Package.METHOD: return createMethod();
			case SQL2003Package.METHOD_PARAMETER: return createMethodParameter();
			case SQL2003Package.NOT_NULL: return createNotNull();
			case SQL2003Package.NUMERIC_FEATURE: return (EObject)createNumericFeature();
			case SQL2003Package.NUMERIC_TYPE: return createNumericType();
			case SQL2003Package.PARAMETER_WITH_MODE: return createParameterWithMode();
			case SQL2003Package.PRIMARY_KEY: return createPrimaryKey();
			case SQL2003Package.PROCEDURE: return createProcedure();
			case SQL2003Package.ROW: return createROW();
			case SQL2003Package.REFERENCE_TYPE: return createReferenceType();
			case SQL2003Package.REFERENTIAL_CONSTRAINT: return createReferentialConstraint();
			case SQL2003Package.SCHEMA: return createSchema();
			case SQL2003Package.STRING_FEATURE: return (EObject)createStringFeature();
			case SQL2003Package.STRUCTURED_TYPE: return createStructuredType();
			case SQL2003Package.TABLE_CHECK_CONSTRAINT: return createTableCheckConstraint();
			case SQL2003Package.TRIGGER: return createTrigger();
			case SQL2003Package.TYPED_TABLE: return createTypedTable();
			case SQL2003Package.UNIQUE_CONSTRAINT: return createUniqueConstraint();
			case SQL2003Package.VIEW: return createView();
			case SQL2003Package.XML_TYPE: return createXMLType();
			default:
	...
	public SQL2003Package getSQL2003Package() {
		return (SQL2003Package)getEPackage();
	}
	 ...
	 */
	@Deprecated
	public static SQL2003Package getPackage() {
		return SQL2003Package.eINSTANCE;
	}
