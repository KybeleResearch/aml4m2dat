 ...
 * <ul>
 *   <li>{@link SQL2003.impl.ConstructedTypeImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ConstructedTypeImpl extends DataTypeImpl implements ConstructedType {
	...
	protected EClass eStaticClass() {
		return SQL2003Package.Literals.CONSTRUCTED_TYPE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SQL2003Package.CONSTRUCTED_TYPE__NAME, oldName, name));
	}
