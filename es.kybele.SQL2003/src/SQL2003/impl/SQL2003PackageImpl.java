...
import SQL2003.Attribute;
import SQL2003.BaseTable;
import SQL2003.BehaviouralComponent;
import SQL2003.BinaryStringType;
import SQL2003.BinaryStringTypes;
import SQL2003.BooleanType;
import SQL2003.BooleanTypes;
import SQL2003.CharacterStringType;
import SQL2003.CharacterStringTypes;
import SQL2003.CollectionType;
import SQL2003.Column;
import SQL2003.ColumnConstraint;
import SQL2003.ConstructedType;
import SQL2003.DataType;
import SQL2003.DatetimeFeatures;
import SQL2003.DatetimeType;
import SQL2003.DatetimeTypes;
import SQL2003.DerivedTable;
import SQL2003.DistinctType;
import SQL2003.Feature;
import SQL2003.Field;
import SQL2003.Function;
import SQL2003.IntervalFeatures;
import SQL2003.IntervalType;
import SQL2003.IntervalTypes;
import SQL2003.MatchTypes;
import SQL2003.Method;
import SQL2003.MethodParameter;
import SQL2003.Multiplier;
import SQL2003.NotNull;
import SQL2003.NumericFeatures;
import SQL2003.NumericRadix;
import SQL2003.NumericType;
import SQL2003.NumericTypes;
import SQL2003.Parameter;
import SQL2003.ParameterMode;
import SQL2003.ParameterWithMode;
import SQL2003.PredefinedType;
import SQL2003.PrimaryKey;
import SQL2003.Procedure;
import SQL2003.ReferenceType;
import SQL2003.ReferentialAction;
...
import SQL2003.StringFeatures;
import SQL2003.StructuralComponent;
import SQL2003.StructuredType;
import SQL2003.Table;
import SQL2003.TableCheckConstraint;
import SQL2003.TableConstraint;
...
import SQL2003.Unit;
import SQL2003.UserDefinedType;
import SQL2003.View;
import SQL2003.XMLType;
import SQL2003.XMLTypes;
 ...
 * @generated
 */
public class SQL2003PackageImpl extends EPackageImpl implements SQL2003Package {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see SQL2003.SQL2003Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private SQL2003PackageImpl() {
		super(eNS_URI, SQL2003Factory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link SQL2003Package#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static SQL2003Package init() {
		if (isInited) return (SQL2003Package)EPackage.Registry.INSTANCE.getEPackage(SQL2003Package.eNS_URI);

		// Obtain or create and register package
		SQL2003PackageImpl theSQL2003Package = (SQL2003PackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof SQL2003PackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new SQL2003PackageImpl());

		isInited = true;

		// Create package meta-data objects
		theSQL2003Package.createPackageContents();

		// Initialize created meta-data
		theSQL2003Package.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theSQL2003Package.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(SQL2003Package.eNS_URI, theSQL2003Package);
		return theSQL2003Package;
	}
	 ...
	 * @generated
	 */
	public EAttribute getTrigger_TriggeredAction() {
	 ...
	 * @generated
	 */
	public SQL2003Factory getSQL2003Factory() {
		return (SQL2003Factory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(triggerEClass, TRIGGER__TRIGGERED_ACTION);
	...
	public void initializePackageContents() {
		...
		initEClass(arrayEClass, SQL2003.ARRAY.class, "ARRAY", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getARRAY_Num_elements(), ecorePackage.getEIntegerObject(), "num_elements", null, 1, 1, SQL2003.ARRAY.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEClass(multisetEClass, SQL2003.MULTISET.class, "MULTISET", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		...
		initEClass(rowEClass, SQL2003.ROW.class, "ROW", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getROW_Super_type(), this.getROW(), this.getROW_Sub_types(), "super_type", null, 0, 1, SQL2003.ROW.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getROW_Fields(), this.getField(), this.getField_Row(), "fields", null, 1, -1, SQL2003.ROW.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getROW_Sub_types(), this.getROW(), this.getROW_Super_type(), "sub_types", null, 0, -1, SQL2003.ROW.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getTrigger_ActionTime(), this.getTriggerActionTime(), "actionTime", null, 1, 1, Trigger.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getTrigger_TriggeredAction(), ecorePackage.getEString(), "triggeredAction", null, 0, 1, Trigger.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
