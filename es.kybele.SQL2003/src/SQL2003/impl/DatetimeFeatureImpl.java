 ...
 * <ul>
 *   <li>{@link SQL2003.impl.DatetimeFeatureImpl#getTypedKey <em>Key</em>}</li>
 *   <li>{@link SQL2003.impl.DatetimeFeatureImpl#getTypedValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DatetimeFeatureImpl extends FeatureImpl implements BasicEMap.Entry<DatetimeFeatures,String> {
	...
	protected EClass eStaticClass() {
		return SQL2003Package.Literals.DATETIME_FEATURE;
	}
	...
	public void setTypedKey(DatetimeFeatures newKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SQL2003Package.DATETIME_FEATURE__KEY, oldKey, key));
	}
	...
	public void setTypedValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SQL2003Package.DATETIME_FEATURE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SQL2003Package.DATETIME_FEATURE__KEY:
				return getTypedKey();
			case SQL2003Package.DATETIME_FEATURE__VALUE:
