 ...
 * <ul>
 *   <li>{@link SQL2003.impl.ReferentialConstraintImpl#getDelete_action <em>Delete action</em>}</li>
 *   <li>{@link SQL2003.impl.ReferentialConstraintImpl#getUpdate_action <em>Update action</em>}</li>
 *   <li>{@link SQL2003.impl.ReferentialConstraintImpl#getMatch <em>Match</em>}</li>
 *   <li>{@link SQL2003.impl.ReferentialConstraintImpl#getReferences <em>References</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ReferentialConstraintImpl extends TableConstraintImpl implements ReferentialConstraint {
	...
	protected EClass eStaticClass() {
		return SQL2003Package.Literals.REFERENTIAL_CONSTRAINT;
	}
	...
	public void setDelete_action(ReferentialAction newDelete_action) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SQL2003Package.REFERENTIAL_CONSTRAINT__DELETE_ACTION, oldDelete_action, delete_action));
	}
	...
	public void setUpdate_action(ReferentialAction newUpdate_action) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SQL2003Package.REFERENTIAL_CONSTRAINT__UPDATE_ACTION, oldUpdate_action, update_action));
	}
	...
	public void setMatch(MatchTypes newMatch) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SQL2003Package.REFERENTIAL_CONSTRAINT__MATCH, oldMatch, match));
	}
	...
	public UniqueConstraint getReferences() {
		if (references != null && references.eIsProxy()) {
			...
			if (references != oldReferences) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SQL2003Package.REFERENTIAL_CONSTRAINT__REFERENCES, oldReferences, references));
			}
		}
		return references;
	}
	...
	public void setReferences(UniqueConstraint newReferences) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SQL2003Package.REFERENTIAL_CONSTRAINT__REFERENCES, oldReferences, references));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case SQL2003Package.REFERENTIAL_CONSTRAINT__MATCH:
				return getMatch();
			case SQL2003Package.REFERENTIAL_CONSTRAINT__REFERENCES:
