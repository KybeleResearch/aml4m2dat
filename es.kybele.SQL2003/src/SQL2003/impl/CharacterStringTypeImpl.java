 ...
 * <ul>
 *   <li>{@link SQL2003.impl.CharacterStringTypeImpl#getDescriptor <em>Descriptor</em>}</li>
 *   <li>{@link SQL2003.impl.CharacterStringTypeImpl#getLength_def <em>Length def</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CharacterStringTypeImpl extends PredefinedTypeImpl implements CharacterStringType {
	...
	protected EClass eStaticClass() {
		return SQL2003Package.Literals.CHARACTER_STRING_TYPE;
	}
	...
	public void setDescriptor(CharacterStringTypes newDescriptor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SQL2003Package.CHARACTER_STRING_TYPE__DESCRIPTOR, oldDescriptor, descriptor));
	}
	...
	public void setLength_def(Integer newLength_def) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SQL2003Package.CHARACTER_STRING_TYPE__LENGTH_DEF, oldLength_def, length_def));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SQL2003Package.CHARACTER_STRING_TYPE__DESCRIPTOR:
				return getDescriptor();
			case SQL2003Package.CHARACTER_STRING_TYPE__LENGTH_DEF:
