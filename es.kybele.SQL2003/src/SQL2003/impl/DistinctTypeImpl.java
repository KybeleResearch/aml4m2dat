 ...
 * <ul>
 *   <li>{@link SQL2003.impl.DistinctTypeImpl#getSource_type <em>Source type</em>}</li>
 *   <li>{@link SQL2003.impl.DistinctTypeImpl#getFeatures <em>Features</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DistinctTypeImpl extends UserDefinedTypeImpl implements DistinctType {
	...
	protected EClass eStaticClass() {
		return SQL2003Package.Literals.DISTINCT_TYPE;
	}
		...
		if (source_type != null && source_type.eIsProxy()) {
			...
			if (source_type != oldSource_type) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SQL2003Package.DISTINCT_TYPE__SOURCE_TYPE, oldSource_type, source_type));
			}
		}
		return source_type;
	}
	...
	public NotificationChain basicSetSource_type(PredefinedType newSource_type, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SQL2003Package.DISTINCT_TYPE__SOURCE_TYPE, oldSource_type, newSource_type);
	...
	public void setSource_type(PredefinedType newSource_type) {
		if (newSource_type != source_type) {
			...
			if (source_type != null)
				msgs = ((InternalEObject)source_type).eInverseRemove(this, SQL2003Package.PREDEFINED_TYPE__IS_SOURCE_OF, PredefinedType.class, msgs);
			if (newSource_type != null)
				msgs = ((InternalEObject)newSource_type).eInverseAdd(this, SQL2003Package.PREDEFINED_TYPE__IS_SOURCE_OF, PredefinedType.class, msgs);
			msgs = basicSetSource_type(newSource_type, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SQL2003Package.DISTINCT_TYPE__SOURCE_TYPE, newSource_type, newSource_type));
	}
	...
	public EList<Feature> getFeatures() {
		if (features == null) {
			features = new EObjectContainmentEList<Feature>(Feature.class, this, SQL2003Package.DISTINCT_TYPE__FEATURES);
		}
		return features;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SQL2003Package.DISTINCT_TYPE__SOURCE_TYPE:
				if (source_type != null)
					msgs = ((InternalEObject)source_type).eInverseRemove(this, SQL2003Package.PREDEFINED_TYPE__IS_SOURCE_OF, PredefinedType.class, msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case SQL2003Package.DISTINCT_TYPE__FEATURES:
