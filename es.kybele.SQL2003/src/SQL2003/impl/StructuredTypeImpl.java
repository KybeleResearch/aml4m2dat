 ...
 * <ul>
 *   <li>{@link SQL2003.impl.StructuredTypeImpl#isIs_final <em>Is final</em>}</li>
 *   <li>{@link SQL2003.impl.StructuredTypeImpl#isIs_instantiable <em>Is instantiable</em>}</li>
 *   <li>{@link SQL2003.impl.StructuredTypeImpl#getSuper_type <em>Super type</em>}</li>
 *   <li>{@link SQL2003.impl.StructuredTypeImpl#getAttributes <em>Attributes</em>}</li>
 *   <li>{@link SQL2003.impl.StructuredTypeImpl#getMethods <em>Methods</em>}</li>
 *   <li>{@link SQL2003.impl.StructuredTypeImpl#getTyped <em>Typed</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StructuredTypeImpl extends UserDefinedTypeImpl implements StructuredType {
	...
	protected EClass eStaticClass() {
		return SQL2003Package.Literals.STRUCTURED_TYPE;
	}
	...
	public void setIs_final(boolean newIs_final) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SQL2003Package.STRUCTURED_TYPE__IS_FINAL, oldIs_final, is_final));
	}
	...
	public void setIs_instantiable(boolean newIs_instantiable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SQL2003Package.STRUCTURED_TYPE__IS_INSTANTIABLE, oldIs_instantiable, is_instantiable));
	}
	...
	public StructuredType getSuper_type() {
		if (super_type != null && super_type.eIsProxy()) {
			...
			if (super_type != oldSuper_type) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SQL2003Package.STRUCTURED_TYPE__SUPER_TYPE, oldSuper_type, super_type));
			}
		}
		return super_type;
	}
	...
	public void setSuper_type(StructuredType newSuper_type) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SQL2003Package.STRUCTURED_TYPE__SUPER_TYPE, oldSuper_type, super_type));
	}
	...
	public EList<Attribute> getAttributes() {
		if (attributes == null) {
			attributes = new EObjectContainmentWithInverseEList<Attribute>(Attribute.class, this, SQL2003Package.STRUCTURED_TYPE__ATTRIBUTES, SQL2003Package.ATTRIBUTE__STRUCTURED);
		}
		return attributes;
	}
	...
	public EList<Method> getMethods() {
		if (methods == null) {
			methods = new EObjectContainmentWithInverseEList<Method>(Method.class, this, SQL2003Package.STRUCTURED_TYPE__METHODS, SQL2003Package.METHOD__STRUCTURED);
		}
		return methods;
	}
	...
	public EList<TypedTable> getTyped() {
		if (typed == null) {
			typed = new EObjectWithInverseResolvingEList<TypedTable>(TypedTable.class, this, SQL2003Package.STRUCTURED_TYPE__TYPED, SQL2003Package.TYPED_TABLE__STRUCTURED);
		}
		return typed;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SQL2003Package.STRUCTURED_TYPE__ATTRIBUTES:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getAttributes()).basicAdd(otherEnd, msgs);
			case SQL2003Package.STRUCTURED_TYPE__METHODS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getMethods()).basicAdd(otherEnd, msgs);
			case SQL2003Package.STRUCTURED_TYPE__TYPED:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SQL2003Package.STRUCTURED_TYPE__IS_FINAL:
				return isIs_final();
			case SQL2003Package.STRUCTURED_TYPE__IS_INSTANTIABLE:
				return isIs_instantiable();
			case SQL2003Package.STRUCTURED_TYPE__SUPER_TYPE:
