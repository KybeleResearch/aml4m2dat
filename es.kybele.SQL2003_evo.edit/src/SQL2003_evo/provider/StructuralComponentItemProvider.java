...
/**
 * This is the item provider adapter for a {@link SQL2003_evo.StructuralComponent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StructuralComponentItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SQL2003_evoPackage.Literals.STRUCTURAL_COMPONENT__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SQL2003_evoPackage.Literals.STRUCTURAL_COMPONENT__TYPE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SQL2003_evoPackage.Literals.STRUCTURAL_COMPONENT__VIEWS,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SQL2003_evoPackage.Literals.STRUCTURAL_COMPONENT__RESTRICTIONS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SQL2003_evoPackage.Literals.STRUCTURAL_COMPONENT__FEATURES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SQL2003_evoPackage.Literals.STRUCTURAL_COMPONENT__FEATURES,
				 SQL2003_evoFactory.eINSTANCE.create(SQL2003_evoPackage.Literals.DATETIME_FEATURE)));

		newChildDescriptors.add
			(createChildParameter
				(SQL2003_evoPackage.Literals.STRUCTURAL_COMPONENT__FEATURES,
				 SQL2003_evoFactory.eINSTANCE.create(SQL2003_evoPackage.Literals.INTERVAL_FEATURE)));

		newChildDescriptors.add
			(createChildParameter
				(SQL2003_evoPackage.Literals.STRUCTURAL_COMPONENT__FEATURES,
				 SQL2003_evoFactory.eINSTANCE.create(SQL2003_evoPackage.Literals.NUMERIC_FEATURE)));

		newChildDescriptors.add
			(createChildParameter
				(SQL2003_evoPackage.Literals.STRUCTURAL_COMPONENT__FEATURES,
				 SQL2003_evoFactory.eINSTANCE.create(SQL2003_evoPackage.Literals.STRING_FEATURE)));
	}
