...
/**
 * This is the item provider adapter for a {@link SQL2003_evo.Table} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TableItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SQL2003_evoPackage.Literals.TABLE__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SQL2003_evoPackage.Literals.TABLE__VIEWS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SQL2003_evoPackage.Literals.TABLE__COLUMNS);
			childrenFeatures.add(SQL2003_evoPackage.Literals.TABLE__RESTRICTIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SQL2003_evoPackage.Literals.TABLE__COLUMNS,
				 SQL2003_evoFactory.eINSTANCE.createColumn()));

		newChildDescriptors.add
			(createChildParameter
				(SQL2003_evoPackage.Literals.TABLE__RESTRICTIONS,
				 SQL2003_evoFactory.eINSTANCE.createNotNull()));

		newChildDescriptors.add
			(createChildParameter
				(SQL2003_evoPackage.Literals.TABLE__RESTRICTIONS,
				 SQL2003_evoFactory.eINSTANCE.createUniqueConstraint()));

		newChildDescriptors.add
			(createChildParameter
				(SQL2003_evoPackage.Literals.TABLE__RESTRICTIONS,
				 SQL2003_evoFactory.eINSTANCE.createPrimaryKey()));

		newChildDescriptors.add
			(createChildParameter
				(SQL2003_evoPackage.Literals.TABLE__RESTRICTIONS,
				 SQL2003_evoFactory.eINSTANCE.createReferentialConstraint()));

		newChildDescriptors.add
			(createChildParameter
				(SQL2003_evoPackage.Literals.TABLE__RESTRICTIONS,
				 SQL2003_evoFactory.eINSTANCE.createTableCheckConstraint()));

		newChildDescriptors.add
			(createChildParameter
				(SQL2003_evoPackage.Literals.TABLE__RESTRICTIONS,
				 SQL2003_evoFactory.eINSTANCE.createTrigger()));
	}
