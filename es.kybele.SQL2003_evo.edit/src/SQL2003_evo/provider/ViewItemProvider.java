...
/**
 * This is the item provider adapter for a {@link SQL2003_evo.View} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SQL2003_evoPackage.Literals.VIEW__TABLES,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SQL2003_evoPackage.Literals.VIEW__COMPONENTS,
				 true,
				 false,
				 true,
				 null,
