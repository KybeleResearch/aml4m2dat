...
/**
 * This is the item provider adapter for a {@link SQL2003_evo.BooleanType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BooleanTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BooleanType_descriptor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BooleanType_descriptor_feature", "_UI_BooleanType_type"),
				 SQL2003_evoPackage.Literals.BOOLEAN_TYPE__DESCRIPTOR,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		BooleanTypes labelValue = ((BooleanType)object).getDescriptor();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(BooleanType.class)) {
			case SQL2003_evoPackage.BOOLEAN_TYPE__DESCRIPTOR:
