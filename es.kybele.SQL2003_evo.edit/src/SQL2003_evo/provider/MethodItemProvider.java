...
/**
 * This is the item provider adapter for a {@link SQL2003_evo.Method} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MethodItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addReturn_typePropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SQL2003_evoPackage.Literals.METHOD__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SQL2003_evoPackage.Literals.METHOD__BODY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SQL2003_evoPackage.Literals.METHOD__OVERRIDE,
				 true,
				 false,
				 true,
				 null,
	 ...
	 * @generated
	 */
	protected void addReturn_typePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Method_return_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Method_return_type_feature", "_UI_Method_type"),
				 SQL2003_evoPackage.Literals.METHOD__RETURN_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SQL2003_evoPackage.Literals.METHOD__PARAMETERS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SQL2003_evoPackage.Literals.METHOD__PARAMETERS,
				 SQL2003_evoFactory.eINSTANCE.createMethodParameter()));
	}
