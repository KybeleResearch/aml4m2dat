 ...
 * <ul>
 *   <li>{@link SQL2003_V3.impl.FunctionImpl#getReturn_type <em>Return type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FunctionImpl extends BehaviouralComponentImpl implements Function {
	...
	protected EClass eStaticClass() {
		return SQL2003_V3Package.Literals.FUNCTION;
	}
		...
		if (return_type != null && return_type.eIsProxy()) {
			...
			if (return_type != oldReturn_type) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SQL2003_V3Package.FUNCTION__RETURN_TYPE, oldReturn_type, return_type));
			}
		}
		return return_type;
	}
	...
	public void setReturn_type(DataType newReturn_type) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SQL2003_V3Package.FUNCTION__RETURN_TYPE, oldReturn_type, return_type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SQL2003_V3Package.FUNCTION__RETURN_TYPE:
