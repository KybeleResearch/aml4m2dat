...
import SQL2003_V3.Attribute;
import SQL2003_V3.BaseTable;
import SQL2003_V3.BehaviouralComponent;
import SQL2003_V3.BinaryStringType;
import SQL2003_V3.BinaryStringTypes;
import SQL2003_V3.BooleanType;
import SQL2003_V3.BooleanTypes;
import SQL2003_V3.CharacterStringType;
import SQL2003_V3.CharacterStringTypes;
import SQL2003_V3.CollectionType;
import SQL2003_V3.Column;
import SQL2003_V3.ColumnConstraint;
import SQL2003_V3.ConstructedType;
import SQL2003_V3.DataType;
import SQL2003_V3.DatetimeFeatures;
import SQL2003_V3.DatetimeType;
import SQL2003_V3.DatetimeTypes;
import SQL2003_V3.DerivedTable;
import SQL2003_V3.DistinctType;
import SQL2003_V3.Domain;
import SQL2003_V3.DomainConstraint;
import SQL2003_V3.Feature;
import SQL2003_V3.Field;
import SQL2003_V3.Function;
import SQL2003_V3.IntervalFeatures;
import SQL2003_V3.IntervalType;
import SQL2003_V3.IntervalTypes;
import SQL2003_V3.MatchTypes;
import SQL2003_V3.Method;
import SQL2003_V3.MethodParameter;
import SQL2003_V3.Multiplier;
import SQL2003_V3.NotNull;
import SQL2003_V3.NumericFeatures;
import SQL2003_V3.NumericRadix;
import SQL2003_V3.NumericType;
import SQL2003_V3.NumericTypes;
import SQL2003_V3.Parameter;
import SQL2003_V3.ParameterMode;
import SQL2003_V3.ParameterWithMode;
import SQL2003_V3.PredefinedType;
import SQL2003_V3.PrimaryKey;
import SQL2003_V3.Procedure;
import SQL2003_V3.ReferenceType;
import SQL2003_V3.ReferentialAction;
import SQL2003_V3.ReferentialConstraint;
import SQL2003_V3.Restriction;
import SQL2003_V3.SQL2003_V3Factory;
import SQL2003_V3.SQL2003_V3Package;
import SQL2003_V3.Schema;
import SQL2003_V3.StringFeatures;
import SQL2003_V3.StructuralComponent;
import SQL2003_V3.StructuredType;
import SQL2003_V3.Table;
import SQL2003_V3.TableCheckConstraint;
import SQL2003_V3.TableConstraint;
import SQL2003_V3.Trigger;
import SQL2003_V3.TriggerActionTime;
import SQL2003_V3.TriggerDescriptor;
import SQL2003_V3.TriggerEvent;
import SQL2003_V3.TriggerLevel;
import SQL2003_V3.TypedTable;
import SQL2003_V3.UniqueConstraint;
import SQL2003_V3.Unit;
import SQL2003_V3.UserDefinedType;
import SQL2003_V3.View;
import SQL2003_V3.XMLType;
import SQL2003_V3.XMLTypes;
 ...
 * @generated
 */
public class SQL2003_V3PackageImpl extends EPackageImpl implements SQL2003_V3Package {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see SQL2003_V3.SQL2003_V3Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private SQL2003_V3PackageImpl() {
		super(eNS_URI, SQL2003_V3Factory.eINSTANCE);
	}
	 ...
	 * @generated
	 */
	public static SQL2003_V3Package init() {
		if (isInited) return (SQL2003_V3Package)EPackage.Registry.INSTANCE.getEPackage(SQL2003_V3Package.eNS_URI);

		// Obtain or create and register package
		SQL2003_V3PackageImpl theSQL2003_V3Package = (SQL2003_V3PackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof SQL2003_V3PackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new SQL2003_V3PackageImpl());

		isInited = true;

		// Create package meta-data objects
		theSQL2003_V3Package.createPackageContents();

		// Initialize created meta-data
		theSQL2003_V3Package.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theSQL2003_V3Package.freeze();

		return theSQL2003_V3Package;
	}
	 ...
	 * @generated
	 */
	public SQL2003_V3Factory getSQL2003_V3Factory() {
		return (SQL2003_V3Factory)getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		domainConstraintEClass.getESuperTypes().add(this.getTableConstraint());
		...
		initEClass(arrayEClass, SQL2003_V3.ARRAY.class, "ARRAY", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getARRAY_Num_elements(), ecorePackage.getEIntegerObject(), "num_elements", null, 1, 1, SQL2003_V3.ARRAY.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getDomain_Constraint(), this.getDomainConstraint(), this.getDomainConstraint_Domain(), "constraint", null, 0, -1, Domain.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getDomainConstraint_Domain(), this.getDomain(), this.getDomain_Constraint(), "domain", null, 1, 1, DomainConstraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(multisetEClass, SQL2003_V3.MULTISET.class, "MULTISET", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		...
		initEClass(rowEClass, SQL2003_V3.ROW.class, "ROW", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getROW_Super_type(), this.getROW(), this.getROW_Sub_types(), "super_type", null, 0, 1, SQL2003_V3.ROW.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getROW_Fields(), this.getField(), this.getField_Row(), "fields", null, 1, -1, SQL2003_V3.ROW.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getROW_Sub_types(), this.getROW(), this.getROW_Super_type(), "sub_types", null, 0, -1, SQL2003_V3.ROW.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
