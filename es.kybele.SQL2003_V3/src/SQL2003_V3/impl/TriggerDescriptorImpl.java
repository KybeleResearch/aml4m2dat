 ...
 * <ul>
 *   <li>{@link SQL2003_V3.impl.TriggerDescriptorImpl#getEvent <em>Event</em>}</li>
 *   <li>{@link SQL2003_V3.impl.TriggerDescriptorImpl#getActionTime <em>Action Time</em>}</li>
 *   <li>{@link SQL2003_V3.impl.TriggerDescriptorImpl#getTriggeredAction <em>Triggered Action</em>}</li>
 *   <li>{@link SQL2003_V3.impl.TriggerDescriptorImpl#getTrigger <em>Trigger</em>}</li>
 *   <li>{@link SQL2003_V3.impl.TriggerDescriptorImpl#getLevel <em>Level</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TriggerDescriptorImpl extends EObjectImpl implements TriggerDescriptor {
	...
	protected EClass eStaticClass() {
		return SQL2003_V3Package.Literals.TRIGGER_DESCRIPTOR;
	}
	...
	public void setEvent(TriggerEvent newEvent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SQL2003_V3Package.TRIGGER_DESCRIPTOR__EVENT, oldEvent, event));
	}
	...
	public void setActionTime(TriggerActionTime newActionTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SQL2003_V3Package.TRIGGER_DESCRIPTOR__ACTION_TIME, oldActionTime, actionTime));
	}
	...
	public void setTriggeredAction(String newTriggeredAction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SQL2003_V3Package.TRIGGER_DESCRIPTOR__TRIGGERED_ACTION, oldTriggeredAction, triggeredAction));
	}
	...
	public Trigger getTrigger() {
		if (eContainerFeatureID != SQL2003_V3Package.TRIGGER_DESCRIPTOR__TRIGGER) return null;
	...
	public NotificationChain basicSetTrigger(Trigger newTrigger, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newTrigger, SQL2003_V3Package.TRIGGER_DESCRIPTOR__TRIGGER, msgs);
		return msgs;
	}
	...
	public void setTrigger(Trigger newTrigger) {
		if (newTrigger != eInternalContainer() || (eContainerFeatureID != SQL2003_V3Package.TRIGGER_DESCRIPTOR__TRIGGER && newTrigger != null)) {
			...
			if (newTrigger != null)
				msgs = ((InternalEObject)newTrigger).eInverseAdd(this, SQL2003_V3Package.TRIGGER__DESCRIPTION, Trigger.class, msgs);
			msgs = basicSetTrigger(newTrigger, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SQL2003_V3Package.TRIGGER_DESCRIPTOR__TRIGGER, newTrigger, newTrigger));
	}
	...
	public void setLevel(TriggerLevel newLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SQL2003_V3Package.TRIGGER_DESCRIPTOR__LEVEL, oldLevel, level));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SQL2003_V3Package.TRIGGER_DESCRIPTOR__TRIGGER:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID) {
			case SQL2003_V3Package.TRIGGER_DESCRIPTOR__TRIGGER:
				return eInternalContainer().eInverseRemove(this, SQL2003_V3Package.TRIGGER__DESCRIPTION, Trigger.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SQL2003_V3Package.TRIGGER_DESCRIPTOR__EVENT:
				return getEvent();
			case SQL2003_V3Package.TRIGGER_DESCRIPTOR__ACTION_TIME:
				return getActionTime();
			case SQL2003_V3Package.TRIGGER_DESCRIPTOR__TRIGGERED_ACTION:
				return getTriggeredAction();
			case SQL2003_V3Package.TRIGGER_DESCRIPTOR__TRIGGER:
				return getTrigger();
			case SQL2003_V3Package.TRIGGER_DESCRIPTOR__LEVEL:
				return getLevel();
		}
