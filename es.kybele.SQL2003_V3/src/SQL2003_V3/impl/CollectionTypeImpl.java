 ...
 * <ul>
 *   <li>{@link SQL2003_V3.impl.CollectionTypeImpl#getSuper_type <em>Super type</em>}</li>
 *   <li>{@link SQL2003_V3.impl.CollectionTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class CollectionTypeImpl extends ConstructedTypeImpl implements CollectionType {
	...
	protected EClass eStaticClass() {
		return SQL2003_V3Package.Literals.COLLECTION_TYPE;
	}
		...
		if (super_type != null && super_type.eIsProxy()) {
			...
			if (super_type != oldSuper_type) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SQL2003_V3Package.COLLECTION_TYPE__SUPER_TYPE, oldSuper_type, super_type));
			}
		}
		return super_type;
	}
	...
	public void setSuper_type(CollectionType newSuper_type) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SQL2003_V3Package.COLLECTION_TYPE__SUPER_TYPE, oldSuper_type, super_type));
	}
	...
	public DataType getType() {
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SQL2003_V3Package.COLLECTION_TYPE__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(DataType newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SQL2003_V3Package.COLLECTION_TYPE__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SQL2003_V3Package.COLLECTION_TYPE__SUPER_TYPE:
				if (resolve) return getSuper_type();
				return basicGetSuper_type();
			case SQL2003_V3Package.COLLECTION_TYPE__TYPE:
