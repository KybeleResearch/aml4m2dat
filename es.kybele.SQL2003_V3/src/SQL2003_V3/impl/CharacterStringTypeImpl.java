 ...
 * <ul>
 *   <li>{@link SQL2003_V3.impl.CharacterStringTypeImpl#getDescriptor <em>Descriptor</em>}</li>
 *   <li>{@link SQL2003_V3.impl.CharacterStringTypeImpl#getLength_def <em>Length def</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CharacterStringTypeImpl extends PredefinedTypeImpl implements CharacterStringType {
	 ...
	 * @ordered
	 */
	protected static final CharacterStringTypes DESCRIPTOR_EDEFAULT = CharacterStringTypes.CHARACTER;
	 ...
	 * @ordered
	 */
	protected CharacterStringTypes descriptor = DESCRIPTOR_EDEFAULT;
	...
	protected EClass eStaticClass() {
		return SQL2003_V3Package.Literals.CHARACTER_STRING_TYPE;
	}
	 ...
	 * @generated
	 */
	public CharacterStringTypes getDescriptor() {
		return descriptor;
	}
	 ...
	 * @generated
	 */
	public void setDescriptor(CharacterStringTypes newDescriptor) {
		CharacterStringTypes oldDescriptor = descriptor;
		descriptor = newDescriptor == null ? DESCRIPTOR_EDEFAULT : newDescriptor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SQL2003_V3Package.CHARACTER_STRING_TYPE__DESCRIPTOR, oldDescriptor, descriptor));
	}
	...
	public void setLength_def(Integer newLength_def) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SQL2003_V3Package.CHARACTER_STRING_TYPE__LENGTH_DEF, oldLength_def, length_def));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SQL2003_V3Package.CHARACTER_STRING_TYPE__DESCRIPTOR:
				return getDescriptor();
			case SQL2003_V3Package.CHARACTER_STRING_TYPE__LENGTH_DEF:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case SQL2003_V3Package.CHARACTER_STRING_TYPE__DESCRIPTOR:
				setDescriptor((CharacterStringTypes)newValue);
				return;
			case SQL2003_V3Package.CHARACTER_STRING_TYPE__LENGTH_DEF:
