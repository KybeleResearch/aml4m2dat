 ...
 * <ul>
 *   <li>{@link SQL2003_V3.impl.ReferenceTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ReferenceTypeImpl extends ConstructedTypeImpl implements ReferenceType {
	...
	protected EClass eStaticClass() {
		return SQL2003_V3Package.Literals.REFERENCE_TYPE;
	}
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SQL2003_V3Package.REFERENCE_TYPE__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(StructuredType newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SQL2003_V3Package.REFERENCE_TYPE__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SQL2003_V3Package.REFERENCE_TYPE__TYPE:
