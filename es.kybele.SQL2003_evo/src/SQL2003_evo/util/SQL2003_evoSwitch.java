 ...
 * @generated
 */
public class SQL2003_evoSwitch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case SQL2003_evoPackage.ATTRIBUTE: {
			...
			case SQL2003_evoPackage.BASE_TABLE: {
			...
			case SQL2003_evoPackage.BEHAVIOURAL_COMPONENT: {
			...
			case SQL2003_evoPackage.BINARY_STRING_TYPE: {
			...
			case SQL2003_evoPackage.BOOLEAN_TYPE: {
			...
			case SQL2003_evoPackage.CHARACTER_STRING_TYPE: {
			...
			case SQL2003_evoPackage.COLLECTION_TYPE: {
			...
			case SQL2003_evoPackage.COLUMN: {
			...
			case SQL2003_evoPackage.COLUMN_CONSTRAINT: {
			...
			case SQL2003_evoPackage.CONSTRUCTED_TYPE: {
			...
			case SQL2003_evoPackage.DATA_TYPE: {
				DataType dataType = (DataType)theEObject;
				T result = caseDataType(dataType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SQL2003_evoPackage.DATETIME_FEATURE: {
			...
			case SQL2003_evoPackage.DATETIME_TYPE: {
			...
			case SQL2003_evoPackage.DERIVED_TABLE: {
			...
			case SQL2003_evoPackage.DISTINCT_TYPE: {
			...
			case SQL2003_evoPackage.FEATURE: {
				Feature feature = (Feature)theEObject;
				T result = caseFeature(feature);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SQL2003_evoPackage.FIELD: {
			...
			case SQL2003_evoPackage.FUNCTION: {
			...
			case SQL2003_evoPackage.INTERVAL_FEATURE: {
			...
			case SQL2003_evoPackage.INTERVAL_TYPE: {
			...
			case SQL2003_evoPackage.MULTISET: {
			...
			case SQL2003_evoPackage.METHOD: {
				Method method = (Method)theEObject;
				T result = caseMethod(method);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SQL2003_evoPackage.METHOD_PARAMETER: {
			...
			case SQL2003_evoPackage.NOT_NULL: {
			...
			case SQL2003_evoPackage.NUMERIC_FEATURE: {
			...
			case SQL2003_evoPackage.NUMERIC_TYPE: {
			...
			case SQL2003_evoPackage.PARAMETER: {
				Parameter parameter = (Parameter)theEObject;
				T result = caseParameter(parameter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SQL2003_evoPackage.PARAMETER_WITH_MODE: {
			...
			case SQL2003_evoPackage.PREDEFINED_TYPE: {
			...
			case SQL2003_evoPackage.PRIMARY_KEY: {
			...
			case SQL2003_evoPackage.PROCEDURE: {
			...
			case SQL2003_evoPackage.REFERENCE_TYPE: {
			...
			case SQL2003_evoPackage.REFERENTIAL_CONSTRAINT: {
			...
			case SQL2003_evoPackage.RESTRICTION: {
				Restriction restriction = (Restriction)theEObject;
				T result = caseRestriction(restriction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SQL2003_evoPackage.SCHEMA: {
				Schema schema = (Schema)theEObject;
				T result = caseSchema(schema);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SQL2003_evoPackage.STRING_FEATURE: {
			...
			case SQL2003_evoPackage.STRUCTURAL_COMPONENT: {
			...
			case SQL2003_evoPackage.STRUCTURED_TYPE: {
			...
			case SQL2003_evoPackage.TABLE: {
				Table table = (Table)theEObject;
				T result = caseTable(table);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SQL2003_evoPackage.TABLE_CHECK_CONSTRAINT: {
			...
			case SQL2003_evoPackage.TABLE_CONSTRAINT: {
			...
			case SQL2003_evoPackage.TRIGGER: {
			...
			case SQL2003_evoPackage.UNIQUE_CONSTRAINT: {
			...
			case SQL2003_evoPackage.USER_DEFINED_TYPE: {
			...
			case SQL2003_evoPackage.XML_TYPE: {
