 ...
 * <ul>
 *   <li>{@link SQL2003_evo.impl.CharacterStringTypeImpl#getDescriptor <em>Descriptor</em>}</li>
 *   <li>{@link SQL2003_evo.impl.CharacterStringTypeImpl#getLength_def <em>Length def</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CharacterStringTypeImpl extends PredefinedTypeImpl implements CharacterStringType {
	...
	protected EClass eStaticClass() {
		return SQL2003_evoPackage.Literals.CHARACTER_STRING_TYPE;
	}
	...
	public void setDescriptor(CharacterStringTypes newDescriptor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SQL2003_evoPackage.CHARACTER_STRING_TYPE__DESCRIPTOR, oldDescriptor, descriptor));
	}
	...
	public void setLength_def(Integer newLength_def) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SQL2003_evoPackage.CHARACTER_STRING_TYPE__LENGTH_DEF, oldLength_def, length_def));
	}
