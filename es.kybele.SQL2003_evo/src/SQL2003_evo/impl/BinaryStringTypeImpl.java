 ...
 * <ul>
 *   <li>{@link SQL2003_evo.impl.BinaryStringTypeImpl#getDescriptor <em>Descriptor</em>}</li>
 *   <li>{@link SQL2003_evo.impl.BinaryStringTypeImpl#getLength_def <em>Length def</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BinaryStringTypeImpl extends PredefinedTypeImpl implements BinaryStringType {
	...
	protected EClass eStaticClass() {
		return SQL2003_evoPackage.Literals.BINARY_STRING_TYPE;
	}
	...
	public void setDescriptor(BinaryStringTypes newDescriptor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SQL2003_evoPackage.BINARY_STRING_TYPE__DESCRIPTOR, oldDescriptor, descriptor));
	}
	...
	public void setLength_def(Integer newLength_def) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SQL2003_evoPackage.BINARY_STRING_TYPE__LENGTH_DEF, oldLength_def, length_def));
	}
