 ...
 * <ul>
 *   <li>{@link SQL2003_evo.impl.PredefinedTypeImpl#getIs_source_of <em>Is source of</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class PredefinedTypeImpl extends DataTypeImpl implements PredefinedType {
	...
	protected EClass eStaticClass() {
		return SQL2003_evoPackage.Literals.PREDEFINED_TYPE;
	}
	...
	public EList<DistinctType> getIs_source_of() {
		if (is_source_of == null) {
			is_source_of = new EObjectWithInverseResolvingEList<DistinctType>(DistinctType.class, this, SQL2003_evoPackage.PREDEFINED_TYPE__IS_SOURCE_OF, SQL2003_evoPackage.DISTINCT_TYPE__SOURCE_TYPE);
		}
		return is_source_of;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SQL2003_evoPackage.PREDEFINED_TYPE__IS_SOURCE_OF:
