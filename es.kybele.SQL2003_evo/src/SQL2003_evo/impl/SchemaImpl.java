 ...
 * <ul>
 *   <li>{@link SQL2003_evo.impl.SchemaImpl#getName <em>Name</em>}</li>
 *   <li>{@link SQL2003_evo.impl.SchemaImpl#getBehaviouralComponents <em>Behavioural Components</em>}</li>
 *   <li>{@link SQL2003_evo.impl.SchemaImpl#getDatatypes <em>Datatypes</em>}</li>
 *   <li>{@link SQL2003_evo.impl.SchemaImpl#getTables <em>Tables</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SchemaImpl extends EObjectImpl implements Schema {
	...
	protected EClass eStaticClass() {
		return SQL2003_evoPackage.Literals.SCHEMA;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SQL2003_evoPackage.SCHEMA__NAME, oldName, name));
	}
	...
	public EList<BehaviouralComponent> getBehaviouralComponents() {
		if (behaviouralComponents == null) {
			behaviouralComponents = new EObjectContainmentWithInverseEList<BehaviouralComponent>(BehaviouralComponent.class, this, SQL2003_evoPackage.SCHEMA__BEHAVIOURAL_COMPONENTS, SQL2003_evoPackage.BEHAVIOURAL_COMPONENT__SCHEMA);
		}
	...
	public EList<DataType> getDatatypes() {
		if (datatypes == null) {
			datatypes = new EObjectContainmentWithInverseEList<DataType>(DataType.class, this, SQL2003_evoPackage.SCHEMA__DATATYPES, SQL2003_evoPackage.DATA_TYPE__SCHEMA);
		}
		return datatypes;
	}
	...
	public EList<Table> getTables() {
		if (tables == null) {
			tables = new EObjectContainmentWithInverseEList<Table>(Table.class, this, SQL2003_evoPackage.SCHEMA__TABLES, SQL2003_evoPackage.TABLE__SCHEMA);
		}
		return tables;
	}
