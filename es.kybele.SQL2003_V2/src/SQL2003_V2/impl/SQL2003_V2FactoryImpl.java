 ...
 * @generated
 */
public class SQL2003_V2FactoryImpl extends EFactoryImpl implements SQL2003_V2Factory {
	/**
	 ...
	 * @generated
	 */
	public static SQL2003_V2Factory init() {
		try {
			SQL2003_V2Factory theSQL2003_V2Factory = (SQL2003_V2Factory)EPackage.Registry.INSTANCE.getEFactory("http://SQL2003_V2.ecore"); 
			if (theSQL2003_V2Factory != null) {
				return theSQL2003_V2Factory;
			}
		}
		catch (Exception exception) {
			EcorePlugin.INSTANCE.log(exception);
		}
		return new SQL2003_V2FactoryImpl();
	}
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case SQL2003_V2Package.ARRAY: return createARRAY();
			case SQL2003_V2Package.ATTRIBUTE: return createAttribute();
			case SQL2003_V2Package.BASE_TABLE: return createBaseTable();
			case SQL2003_V2Package.BINARY_STRING_TYPE: return createBinaryStringType();
			case SQL2003_V2Package.BOOLEAN_TYPE: return createBooleanType();
			case SQL2003_V2Package.CHARACTER_STRING_TYPE: return createCharacterStringType();
			case SQL2003_V2Package.COLUMN: return createColumn();
			case SQL2003_V2Package.DATETIME_FEATURE: return (EObject)createDatetimeFeature();
			case SQL2003_V2Package.DATETIME_TYPE: return createDatetimeType();
			case SQL2003_V2Package.DERIVED_TABLE: return createDerivedTable();
			case SQL2003_V2Package.DISTINCT_TYPE: return createDistinctType();
			case SQL2003_V2Package.FIELD: return createField();
			case SQL2003_V2Package.FUNCTION: return createFunction();
			case SQL2003_V2Package.INTERVAL_FEATURE: return (EObject)createIntervalFeature();
			case SQL2003_V2Package.INTERVAL_TYPE: return createIntervalType();
			case SQL2003_V2Package.MULTISET: return createMULTISET();
			case SQL2003_V2Package.METHOD: return createMethod();
			case SQL2003_V2Package.METHOD_PARAMETER: return createMethodParameter();
			case SQL2003_V2Package.NOT_NULL: return createNotNull();
			case SQL2003_V2Package.NUMERIC_FEATURE: return (EObject)createNumericFeature();
			case SQL2003_V2Package.NUMERIC_TYPE: return createNumericType();
			case SQL2003_V2Package.PARAMETER_WITH_MODE: return createParameterWithMode();
			case SQL2003_V2Package.PRIMARY_KEY: return createPrimaryKey();
			case SQL2003_V2Package.PROCEDURE: return createProcedure();
			case SQL2003_V2Package.ROW: return createROW();
			case SQL2003_V2Package.REFERENCE_TYPE: return createReferenceType();
			case SQL2003_V2Package.REFERENTIAL_CONSTRAINT: return createReferentialConstraint();
			case SQL2003_V2Package.SCHEMA: return createSchema();
			case SQL2003_V2Package.STRING_FEATURE: return (EObject)createStringFeature();
			case SQL2003_V2Package.STRUCTURED_TYPE: return createStructuredType();
			case SQL2003_V2Package.TABLE_CHECK_CONSTRAINT: return createTableCheckConstraint();
			case SQL2003_V2Package.TRIGGER: return createTrigger();
			case SQL2003_V2Package.TRIGGER_DESCRIPTOR: return createTriggerDescriptor();
			case SQL2003_V2Package.TYPED_TABLE: return createTypedTable();
			case SQL2003_V2Package.UNIQUE_CONSTRAINT: return createUniqueConstraint();
			case SQL2003_V2Package.VIEW: return createView();
			case SQL2003_V2Package.XML_TYPE: return createXMLType();
			case SQL2003_V2Package.DOMAIN: return createDomain();
			default:
	 ...
	 * @generated
	 */
	public SQL2003_V2Package getSQL2003_V2Package() {
		return (SQL2003_V2Package)getEPackage();
	}
	 ...
	 */
	@Deprecated
	public static SQL2003_V2Package getPackage() {
		return SQL2003_V2Package.eINSTANCE;
	}

} //SQL2003_V2FactoryImpl
