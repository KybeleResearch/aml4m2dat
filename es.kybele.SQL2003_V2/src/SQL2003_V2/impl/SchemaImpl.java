 ...
 * <ul>
 *   <li>{@link SQL2003_V2.impl.SchemaImpl#getName <em>Name</em>}</li>
 *   <li>{@link SQL2003_V2.impl.SchemaImpl#getBehaviouralComponents <em>Behavioural Components</em>}</li>
 *   <li>{@link SQL2003_V2.impl.SchemaImpl#getDatatypes <em>Datatypes</em>}</li>
 *   <li>{@link SQL2003_V2.impl.SchemaImpl#getTables <em>Tables</em>}</li>
 *   <li>{@link SQL2003_V2.impl.SchemaImpl#getDomains <em>Domains</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SchemaImpl extends EObjectImpl implements Schema {
	...
	protected EClass eStaticClass() {
		return SQL2003_V2Package.Literals.SCHEMA;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SQL2003_V2Package.SCHEMA__NAME, oldName, name));
	}
	...
	public EList<BehaviouralComponent> getBehaviouralComponents() {
		if (behaviouralComponents == null) {
			behaviouralComponents = new EObjectContainmentWithInverseEList<BehaviouralComponent>(BehaviouralComponent.class, this, SQL2003_V2Package.SCHEMA__BEHAVIOURAL_COMPONENTS, SQL2003_V2Package.BEHAVIOURAL_COMPONENT__SCHEMA);
		}
	...
	public EList<DataType> getDatatypes() {
		if (datatypes == null) {
			datatypes = new EObjectContainmentWithInverseEList<DataType>(DataType.class, this, SQL2003_V2Package.SCHEMA__DATATYPES, SQL2003_V2Package.DATA_TYPE__SCHEMA);
		}
		return datatypes;
	}
	...
	public EList<Table> getTables() {
		if (tables == null) {
			tables = new EObjectContainmentWithInverseEList<Table>(Table.class, this, SQL2003_V2Package.SCHEMA__TABLES, SQL2003_V2Package.TABLE__SCHEMA);
		}
		return tables;
	}
	...
	public EList<Domain> getDomains() {
		if (domains == null) {
			domains = new EObjectContainmentWithInverseEList<Domain>(Domain.class, this, SQL2003_V2Package.SCHEMA__DOMAINS, SQL2003_V2Package.DOMAIN__SCHEMA);
		}
		return domains;
	}
