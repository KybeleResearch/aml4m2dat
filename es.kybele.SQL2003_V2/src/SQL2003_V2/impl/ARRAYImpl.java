 ...
 * <ul>
 *   <li>{@link SQL2003_V2.impl.ARRAYImpl#getNum_elements <em>Num elements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ARRAYImpl extends CollectionTypeImpl implements ARRAY {
	...
	protected EClass eStaticClass() {
		return SQL2003_V2Package.Literals.ARRAY;
	}
	...
	public void setNum_elements(Integer newNum_elements) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SQL2003_V2Package.ARRAY__NUM_ELEMENTS, oldNum_elements, num_elements));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SQL2003_V2Package.ARRAY__NUM_ELEMENTS:
