 ...
 * <ul>
 *   <li>{@link SQL2003_V2.impl.DatetimeTypeImpl#getDescriptor <em>Descriptor</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DatetimeTypeImpl extends PredefinedTypeImpl implements DatetimeType {
	...
	protected EClass eStaticClass() {
		return SQL2003_V2Package.Literals.DATETIME_TYPE;
	}
	...
	public void setDescriptor(DatetimeTypes newDescriptor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SQL2003_V2Package.DATETIME_TYPE__DESCRIPTOR, oldDescriptor, descriptor));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SQL2003_V2Package.DATETIME_TYPE__DESCRIPTOR:
