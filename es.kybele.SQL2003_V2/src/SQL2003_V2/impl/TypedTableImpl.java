 ...
 * <ul>
 *   <li>{@link SQL2003_V2.impl.TypedTableImpl#getStructured <em>Structured</em>}</li>
 *   <li>{@link SQL2003_V2.impl.TypedTableImpl#getSupertable <em>Supertable</em>}</li>
 *   <li>{@link SQL2003_V2.impl.TypedTableImpl#getSubtables <em>Subtables</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TypedTableImpl extends BaseTableImpl implements TypedTable {
	...
	protected EClass eStaticClass() {
		return SQL2003_V2Package.Literals.TYPED_TABLE;
	}
		...
		if (structured != null && structured.eIsProxy()) {
			...
			if (structured != oldStructured) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SQL2003_V2Package.TYPED_TABLE__STRUCTURED, oldStructured, structured));
			}
		}
		return structured;
	}
	...
	public NotificationChain basicSetStructured(StructuredType newStructured, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SQL2003_V2Package.TYPED_TABLE__STRUCTURED, oldStructured, newStructured);
	...
	public void setStructured(StructuredType newStructured) {
		if (newStructured != structured) {
			...
			if (structured != null)
				msgs = ((InternalEObject)structured).eInverseRemove(this, SQL2003_V2Package.STRUCTURED_TYPE__TYPED, StructuredType.class, msgs);
			if (newStructured != null)
				msgs = ((InternalEObject)newStructured).eInverseAdd(this, SQL2003_V2Package.STRUCTURED_TYPE__TYPED, StructuredType.class, msgs);
			msgs = basicSetStructured(newStructured, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SQL2003_V2Package.TYPED_TABLE__STRUCTURED, newStructured, newStructured));
	}
	...
	public TypedTable getSupertable() {
		if (supertable != null && supertable.eIsProxy()) {
			...
			if (supertable != oldSupertable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SQL2003_V2Package.TYPED_TABLE__SUPERTABLE, oldSupertable, supertable));
			}
		}
		return supertable;
	}
	...
	public NotificationChain basicSetSupertable(TypedTable newSupertable, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SQL2003_V2Package.TYPED_TABLE__SUPERTABLE, oldSupertable, newSupertable);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSupertable(TypedTable newSupertable) {
		if (newSupertable != supertable) {
			NotificationChain msgs = null;
			if (supertable != null)
				msgs = ((InternalEObject)supertable).eInverseRemove(this, SQL2003_V2Package.TYPED_TABLE__SUBTABLES, TypedTable.class, msgs);
			if (newSupertable != null)
				msgs = ((InternalEObject)newSupertable).eInverseAdd(this, SQL2003_V2Package.TYPED_TABLE__SUBTABLES, TypedTable.class, msgs);
			msgs = basicSetSupertable(newSupertable, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SQL2003_V2Package.TYPED_TABLE__SUPERTABLE, newSupertable, newSupertable));
	}
	...
	public EList<TypedTable> getSubtables() {
		if (subtables == null) {
			subtables = new EObjectWithInverseResolvingEList<TypedTable>(TypedTable.class, this, SQL2003_V2Package.TYPED_TABLE__SUBTABLES, SQL2003_V2Package.TYPED_TABLE__SUPERTABLE);
		}
		return subtables;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SQL2003_V2Package.TYPED_TABLE__STRUCTURED:
				if (structured != null)
					msgs = ((InternalEObject)structured).eInverseRemove(this, SQL2003_V2Package.STRUCTURED_TYPE__TYPED, StructuredType.class, msgs);
				return basicSetStructured((StructuredType)otherEnd, msgs);
			case SQL2003_V2Package.TYPED_TABLE__SUPERTABLE:
				if (supertable != null)
					msgs = ((InternalEObject)supertable).eInverseRemove(this, SQL2003_V2Package.TYPED_TABLE__SUBTABLES, TypedTable.class, msgs);
				return basicSetSupertable((TypedTable)otherEnd, msgs);
			case SQL2003_V2Package.TYPED_TABLE__SUBTABLES:
