 ...
 * <ul>
 *   <li>{@link SQL2003_V2.impl.ROWImpl#getSuper_type <em>Super type</em>}</li>
 *   <li>{@link SQL2003_V2.impl.ROWImpl#getFields <em>Fields</em>}</li>
 *   <li>{@link SQL2003_V2.impl.ROWImpl#getSub_types <em>Sub types</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ROWImpl extends ConstructedTypeImpl implements ROW {
	...
	protected EClass eStaticClass() {
		return SQL2003_V2Package.Literals.ROW;
	}
		...
		if (super_type != null && super_type.eIsProxy()) {
			...
			if (super_type != oldSuper_type) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SQL2003_V2Package.ROW__SUPER_TYPE, oldSuper_type, super_type));
			}
		}
		return super_type;
	}
	...
	public NotificationChain basicSetSuper_type(ROW newSuper_type, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SQL2003_V2Package.ROW__SUPER_TYPE, oldSuper_type, newSuper_type);
	...
	public void setSuper_type(ROW newSuper_type) {
		if (newSuper_type != super_type) {
			...
			if (super_type != null)
				msgs = ((InternalEObject)super_type).eInverseRemove(this, SQL2003_V2Package.ROW__SUB_TYPES, ROW.class, msgs);
			if (newSuper_type != null)
				msgs = ((InternalEObject)newSuper_type).eInverseAdd(this, SQL2003_V2Package.ROW__SUB_TYPES, ROW.class, msgs);
			msgs = basicSetSuper_type(newSuper_type, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SQL2003_V2Package.ROW__SUPER_TYPE, newSuper_type, newSuper_type));
	}
	...
	public EList<Field> getFields() {
		if (fields == null) {
			fields = new EObjectContainmentWithInverseEList<Field>(Field.class, this, SQL2003_V2Package.ROW__FIELDS, SQL2003_V2Package.FIELD__ROW);
		}
		return fields;
	}
	...
	public EList<ROW> getSub_types() {
		if (sub_types == null) {
			sub_types = new EObjectWithInverseResolvingEList<ROW>(ROW.class, this, SQL2003_V2Package.ROW__SUB_TYPES, SQL2003_V2Package.ROW__SUPER_TYPE);
		}
		return sub_types;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SQL2003_V2Package.ROW__SUPER_TYPE:
				if (super_type != null)
					msgs = ((InternalEObject)super_type).eInverseRemove(this, SQL2003_V2Package.ROW__SUB_TYPES, ROW.class, msgs);
				return basicSetSuper_type((ROW)otherEnd, msgs);
			case SQL2003_V2Package.ROW__FIELDS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getFields()).basicAdd(otherEnd, msgs);
			case SQL2003_V2Package.ROW__SUB_TYPES:
