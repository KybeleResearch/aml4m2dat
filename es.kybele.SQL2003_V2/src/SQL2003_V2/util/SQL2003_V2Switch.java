 ...
 * @generated
 */
public class SQL2003_V2Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case SQL2003_V2Package.ATTRIBUTE: {
			...
			case SQL2003_V2Package.BASE_TABLE: {
			...
			case SQL2003_V2Package.BEHAVIOURAL_COMPONENT: {
			...
			case SQL2003_V2Package.BINARY_STRING_TYPE: {
			...
			case SQL2003_V2Package.BOOLEAN_TYPE: {
			...
			case SQL2003_V2Package.CHARACTER_STRING_TYPE: {
			...
			case SQL2003_V2Package.COLLECTION_TYPE: {
			...
			case SQL2003_V2Package.COLUMN_CONSTRAINT: {
			...
			case SQL2003_V2Package.CONSTRUCTED_TYPE: {
			...
			case SQL2003_V2Package.DATA_TYPE: {
				DataType dataType = (DataType)theEObject;
				T result = caseDataType(dataType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SQL2003_V2Package.DATETIME_FEATURE: {
			...
			case SQL2003_V2Package.DATETIME_TYPE: {
			...
			case SQL2003_V2Package.DERIVED_TABLE: {
			...
			case SQL2003_V2Package.DISTINCT_TYPE: {
			...
			case SQL2003_V2Package.FEATURE: {
				Feature feature = (Feature)theEObject;
				T result = caseFeature(feature);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SQL2003_V2Package.FIELD: {
			...
			case SQL2003_V2Package.FUNCTION: {
			...
			case SQL2003_V2Package.INTERVAL_FEATURE: {
			...
			case SQL2003_V2Package.INTERVAL_TYPE: {
			...
			case SQL2003_V2Package.MULTISET: {
			...
			case SQL2003_V2Package.METHOD: {
				Method method = (Method)theEObject;
				T result = caseMethod(method);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SQL2003_V2Package.METHOD_PARAMETER: {
			...
			case SQL2003_V2Package.NOT_NULL: {
			...
			case SQL2003_V2Package.NUMERIC_FEATURE: {
			...
			case SQL2003_V2Package.NUMERIC_TYPE: {
			...
			case SQL2003_V2Package.PARAMETER: {
				Parameter parameter = (Parameter)theEObject;
				T result = caseParameter(parameter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SQL2003_V2Package.PARAMETER_WITH_MODE: {
			...
			case SQL2003_V2Package.PREDEFINED_TYPE: {
			...
			case SQL2003_V2Package.PRIMARY_KEY: {
			...
			case SQL2003_V2Package.PROCEDURE: {
			...
			case SQL2003_V2Package.REFERENCE_TYPE: {
			...
			case SQL2003_V2Package.REFERENTIAL_CONSTRAINT: {
			...
			case SQL2003_V2Package.RESTRICTION: {
				Restriction restriction = (Restriction)theEObject;
				T result = caseRestriction(restriction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SQL2003_V2Package.SCHEMA: {
				Schema schema = (Schema)theEObject;
				T result = caseSchema(schema);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SQL2003_V2Package.STRING_FEATURE: {
			...
			case SQL2003_V2Package.STRUCTURAL_COMPONENT: {
			...
			case SQL2003_V2Package.STRUCTURED_TYPE: {
			...
			case SQL2003_V2Package.TABLE: {
				Table table = (Table)theEObject;
				T result = caseTable(table);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SQL2003_V2Package.TABLE_CHECK_CONSTRAINT: {
			...
			case SQL2003_V2Package.TABLE_CONSTRAINT: {
			...
			case SQL2003_V2Package.TRIGGER: {
			...
			case SQL2003_V2Package.UNIQUE_CONSTRAINT: {
			...
			case SQL2003_V2Package.USER_DEFINED_TYPE: {
			...
			case SQL2003_V2Package.XML_TYPE: {
